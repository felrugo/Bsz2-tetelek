...
\end{shaded}
\begin{framed}
REGULÁRIS GRÁFBAN TELJES PÁROSÍTÁS Tétel: Minden reguláris páros gráfban létezik teljes párosítás.
\end{framed}
\begin{leftbar}
Bizonyítás:
...
\end{framed}
\begin{leftbar}
Bizonyítás: Elég azt igazolni, hogy $\chi_e(G) \leq \Delta(G)$ az előző állítás miatt. Létezik olyan H páros gráf, melynek G részgráfja, és H minden csúcsának fokszáma $\Delta(G)$. Ha sikerül a $\Delta(G)$-reguláris H gráf éleit $\Delta(G)$ színnel kiszínezni, akkor egyúttal a G részgráf éleinek is megkapjuk egy ugyanennyi színnel való színezését. H gráf élszínezéséhez elegendő azt megmutatni, hogy tetszőleges reguláris páros gráfban létezik teljes párosítás, ezt pedig már bizonyítottuk egy fentebbi tételben. Ugyanis akkor H egy teljes párosítását kiszínezve az első színnel, a színezetlen élek
egy $(\Delta(G) − 1)$-reguláris páros gráfot alkotnak, abban is találunk teljes párosítást, ez a második színt kapja, és így tovább.
\end{leftbar}
